...
RSpec.describe UpdateAllPodcastsJob, type: :job do
  let!(:podcast) { FactoryGirl.create :podcast, updated_at: 2.hours.ago }
  ...
  context 'when podcast is updated more often than published' do
    before do
      podcast.update_attributes updated_at: 30.minutes.ago
  ...
  context 'when podcast has not been updated more than hour' do
    before do
      podcast.update_attributes updated_at: 2.hours.ago
